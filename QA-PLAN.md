...
- after confirming:
  - Fiona is created
  - Greg is created
  - Greg has Member Big = null
  - Fiona has Member Big = Greg Hall
  - page refreshes automatically
...
- after confirming:
  - Henry row exists
  - Henry has Member Big = null
  - Ben now points to Henry
- page refreshes automatically
...
- after confirming:
  - mentor row is gone
  - all affected dependent rows now have Member Big = null
  - page refreshes automatically
